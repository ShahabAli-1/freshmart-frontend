...
const MyOrder = () => {
  ...
  useEffect(() => {
    if (typeof window !== "undefined") {
      // Fetch jwt and user from sessionStorage
      ...
      if (!jwtToken) {
        ...
        getMyOrder(jwtToken, userInfo.id);
      }
    }
  }, [router]);

  const getMyOrder = async (jwtToken, userId) => {
    const orderList_ = await GlobalApi.getMyOrder(jwtToken, userId);
    console.log(orderList_);
    setOrderList(orderList_);
  };
